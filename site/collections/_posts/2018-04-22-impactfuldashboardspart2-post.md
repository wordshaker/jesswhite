...
In Part One of this series of posts <a href="{{site.baseurl}}/blog/impactfuldashboardspart1-post" rel="noreferrer" target="_blank">creation of impactful dashboards</a> we covered what a dashboard is, and some tips on what to do when thinking about creating a dashboard.
